<section class="endorsement" id="about">
    <div>
        <div class="note-block">
            <img src="{{ asset('images/SACE.png') }}" alt="SACE" class="note-icon-img">
    ...
    <aside class="sace-logos" id="contact" aria-label="SACE endorsement logos">
        <img src="{{ asset('images/SACE_logo.png') }}" alt="SACE - South African Council for Educators" class="sace-logo-main">
    </aside>
</section>
